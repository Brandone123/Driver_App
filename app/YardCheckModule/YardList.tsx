    ...
    <View style={tw`flex-1`}>
      <View style={tw`flex`}>
        ...
        <View style={tw`flex-row justify-between border-t border-b border-gray-300 py-3 px-4`}>
          ...
          <View style={tw`flex justify-between px-2 mt-2 ml-2 mr-2 rounded-lg bg-white border border-gray-300`}>
            <View style={[tw`h-full w-2 absolute  rounded-l-lg left-0`, { backgroundColor: '#00D3AD' }]} />
            <View style={tw`relative`}>
              <View style={tw`flex-row p-1 ml-1 items-center justify-between`}>
                  <View style={tw`flex flex-row`}>
                    <Pressable onPress={() => navigation.navigate("YardReservation")}>
                      <Text style={[tw`text-lg font-bold`, { color: '#1867C0' }]}>Yard #63554</Text>
                    </Pressable>
              ...
              <View style={tw`flex-row mb-1 pl-2`}>
                <View style={tw`flex-col`}>
                    ...
                    Status: <Text style={[{ color: '#00D3AD' }]}>Open</Text>
                    </Text>
                </View>
              </View>
            </View>
          ...
          <View style={tw`flex justify-between px-2 mt-2 ml-2 mr-2 rounded-lg bg-white border border-gray-300`}>
            <View style={[tw`h-full w-2 absolute  rounded-l-lg left-0`, {backgroundColor: '#CE0053' }]} />
            <View style={tw`relative`}>
                <View style={tw`flex-row p-1 ml-1 items-center justify-between`}>
                    <View style={tw`flex flex-row`}>
                    <Pressable onPress={() => navigation.navigate("YardReservation")}>
                      <Text style={[tw`text-lg font-bold`, { color: '#1867C0' }]}>Yard #25554</Text>
                    </Pressable>
                        <Text style={tw`text-sm text-gray-400 ml-24`}>39.284176/-76.622368</Text>
                    </View>
                </View>
                ...
                <View style={tw`flex-col`}>
                    ...
                    <Text style={tw`text-sm font-bold`}>
                    Status: <Text style={[{color: '#CE0053' }]}>Closed</Text>
                    </Text>
                </View>
                </View>
            </View>
          ...
          <View style={tw`flex justify-between px-2 mt-2 ml-2 mr-2 rounded-lg bg-white border border-gray-300`}>
            <View style={tw`bg-yellow-300 h-full w-2 absolute  rounded-l-lg left-0`} />
            <View style={tw`relative`}>
                <View style={tw`flex-row p-1 ml-1 items-center justify-between`}>
                    <View style={tw`flex flex-row`}>
                        <Pressable onPress={() => navigation.navigate("YardReservation")}>
                ...
                <View style={tw`flex-col`}>
                    ...
                    <Text style={tw`text-sm font-bold`}>
                    Status: <Text style={tw`text-yellow-300`}>Restricted</Text>
                    </Text>
                </View>
                </View>
            </View>
          ...
          <View style={tw`flex justify-between px-2 mt-2 ml-2 mr-2 rounded-lg bg-white border border-gray-300`}>
            ...
            <View style={tw`relative`}>
                <View style={tw`flex-row p-1 ml-1 items-center justify-between`}>
                    <View style={tw`flex flex-row`}>
                        <Pressable onPress={() => navigation.navigate("YardReservation")}>
                          <Text style={[tw`text-lg font-bold`, { color: '#1867C0' }]}>Yard #17309</Text>
                        </Pressable>
                        <Text style={tw`text-sm text-gray-400 ml-24`}>39.284176/-76.622368</Text>
                    </View>
                </View>
              ...
              {pages.map((page, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    currentPage === index && { backgroundColor: '#1867C0' },
                  ]}
                >
                  <Text
                    style={[
